        ...
        <div class="card">
            <div class="card-header">
                <h4 class="mb-0">
                    ...
                    Editar Cliente API: <?php echo htmlspecialchars($cliente['nombre'] . ' ' . $cliente['apellido']); ?>
                </h4>
            </div>
            <div class="card-body">
                ...
                <form method="POST" action="<?php echo BASE_URL; ?>index.php?action=cliente_api&method=update">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check form-switch mt-2">
                                    <input class="form-check-input" 
                                           ...
                                           name="estado" 
                                           value="1" 
                                           <?php echo isset($formData['estado']) && $formData['estado'] ? 'checked' : ''; ?>>
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="<?php echo BASE_URL; ?>index.php?action=cliente_api&method=view&id=<?php echo $cliente['id']; ?>" class="btn btn-secondary">
